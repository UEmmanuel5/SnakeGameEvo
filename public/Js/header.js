...
// Set the player's name from the server in the Player class instance
if (typeof playerNameFromServer !== 'undefined') {
    player.name = playerNameFromServer;
}
...
export function updateHeader() {
    ...
    document.querySelector('header ul li:nth-child(2)').textContent = `Player's Score: ${player.high_score}`;
    document.querySelector('header ul li:nth-child(3)').textContent = `Score: ${player.score}`;
}
