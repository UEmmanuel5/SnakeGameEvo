        ...
        <table class="table">
            <thead>
                <tr>
                    ...
                    <td class="data-info">score</td>
                </tr>
            </thead>
            <tbody>
                <?php
                $sql = "SELECT * FROM create_player_account";
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        echo '<tr>
                                ...
                                <td class="btn-data-info">
                                    <button class="btn-primary"><a href="updatePlayer.php?updateid=' . $name . '" class="text-light">Update</a></button>
                                    <button class="btn-danger"><a href="deletePlayer.php?deleteid=' . $name . '" class="text-light">Delete</a></button>
                                </td>
                        </tr>';
